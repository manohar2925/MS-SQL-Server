...
create database nareshit_march
...
insert into empoyee_details values (70000)
...
insert into product1 values ('Car'), ('Bus') ,('Train')
...
-- it will completely delete the table */
...
1) Create a table
	 ...
	 - identity column
	 - default column
2) Insrert the values
3) Query the table
4) Truncate the table and drop the table (get the difference)*/
